...
import Whois from './assets/whoispng.png';
import Cekwarna from './assets/cekwarna.png';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center">
          <div className="bg-[#11141B] rounded-lg overflow-hidden shadow-lg w-full sm:w-4/5 md:w-full">
            <Image src={Whois} alt="NEAR AI" className="w-full h-50 object-cover"/>
            <div className="p-6">
          ...
          <div className="bg-[#11141B] rounded-lg overflow-hidden shadow-lg w-full sm:w-4/5 md:w-full">
            <Image src={Cekwarna} alt="NEAR AI" className="w-full h-50 object-cover"/>
            <div className="p-6">
